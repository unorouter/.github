...
- **Authenticity by default.** Channels probed continuously, fakes auto-demoted. [Probe code is public.](https://github.com/unorouter/new-api-sync/blob/main/src/core/testing/authenticity.ts)
